const Navbar = () => {
  return (
    <>
      <nav className="flex  items-center justify-center flex-wrap p6 pt-2 pb-2  ">
        <div className="flex flex-shrink-0 content-center text-white mr-6">
          <svg
            className="ml-6 drop-shadow-xl"
          ...
          <span className="font-bold text-3xl tracking-tight mt-3 ml-1 drop-shadow-xl">Chattarika Journey to DEV.</span>
        </div>
      </nav>
    </>
  )
